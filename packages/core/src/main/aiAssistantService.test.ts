...
describe("AiAssistantService", () => {
  it("encrypts the API key and never returns it to the renderer", async () => {
    ...
    const record = await service.saveSettings({ apiKey: " mock-key ", model: "gpt-5.6-terra" });
