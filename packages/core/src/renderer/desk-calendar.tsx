...
import {
  ...
  weekdayLabels,
  type Range
} from "./lib/deskCalendarDates";
import "./globals.css";
import "./theme.css";
import "./styles.css";
/* Desk-calendar overlay styles, loaded unlayered right after styles.css: this
 * window already loads styles.css twice (layered through globals.css, unlayered
 * here), so the overlay rules must stay unlayered and last to keep the cascade
 * position they had at the end of styles.css. */
import "./styles/desk-calendar.css";
