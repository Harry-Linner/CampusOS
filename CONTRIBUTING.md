...
- Update `README.md` when product scope, assumptions, or implementation status changes. Never create a second source of truth for a decision that is already documented elsewhere.
