...
- Update `README.md` and the applicable documents under `docs/` when product scope, assumptions, or implementation status changes. Never create a second source of truth for a decision that is already documented elsewhere.
